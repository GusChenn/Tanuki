...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL] =
        LAYOUT(KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P,
               KC_BSPC, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L,
               KC_SCLN, TG(_GL), KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N,
               KC_M, KC_QUOT, KC_SLSH, KC_ENT, KC_TAB, KC_ESC, KC_LCTL, KC_LALT,
               KC_COMMA, LT(_DL, KC_SPC), LT(_UL, KC_SPC), KC_DOT, KC_LGUI),

    [_DL] = LAYOUT(KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9,
                   KC_F10, KC_F11, KC_F12, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6,
                   KC_7, KC_8, KC_9, KC_0, KC_TRNS, KC_TRNS, KC_PSCR, KC_TRNS,
                   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                   KC_TRNS, KC_TRNS, KC_TRNS, KC_F1, KC_TRNS, RESET, KC_TRNS,
                   KC_TRNS, KC_LGUI, KC_TRNS, KC_TRNS),

    [_UL] =
        LAYOUT(KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, KC_PIPE, KC_BSLS, KC_PLUS,
               KC_UNDS, KC_MINS, KC_EQL, KC_DEL, KC_EXLM, KC_AT, KC_HASH,
               KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN,
               KC_TRNS, KC_TRNS, KC_FN0, RGB_TOG, KC_TRNS, KC_TRNS, KC_TRNS,
               KC_TRNS, RGB_SAD, RGB_VAD, KC_TRNS, KC_TRNS, KC_TRNS, KC_GRV,
...
void matrix_scan_kb(void) {
  if (lRGB == true) {
    ...
    // if on blocked layer and the spacebar has been released reset to baselayer
    // and set colours to white
...
// set mCalled to 1 when a button is pressed to make sure the leds aren't
// continuesly updated.
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  mCalled = 1;

  // uncommenting the line below causes the lights to flicker when typing on the
  // keyboard. rgblight_sethsv(0,255,0);
